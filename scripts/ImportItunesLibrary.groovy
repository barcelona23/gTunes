                ...
                artistClass.withTransaction { tx ->
                    ...
                    albums.each { albumTitle, albumDetails ->
                        ...
                        albumDetails.tracks?.each { trackInfo ->
                            song = songClass.newInstance(title: trackInfo.name ?: 'TrackName', genre: trackInfo.genre ?: 'Unknown', year: trackInfo.year ?: 2012,
                                    trackNumber: trackInfo.tracknumber ?: 1, duration: trackInfo.totaltime ?: 0, artist: artist)
